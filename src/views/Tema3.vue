  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Auditoría infraestructura tecnológica
              ...
              .col-lg
                ul.lista-ul--color.lista-ul.mb-4
                  li.mb-3
                    i.fas.fa-play(style="color: #294DDC")
                    |
                    p.mb-0 Ahora se verá cómo hacer el escaneo más básico, es el de test sin credenciales de acceso. Porque se puede configurar un #[i proxy] que capture y genere un #[i script] de inicio de sesión, para pruebas más completas, pero es un tema más avanzado que no está al alcance en este momento por ahora.
                  li
                    i.fas.fa-play(style="color: #294DDC")
                    |
                    p.mb-0 Haga clic en #[b #[i Automated Scan]] (escaneo automático).
        .row.justify-content-center(titulo="")
          .col-10.p-4
            .row
              .col-lg-auto.mb-4.mb-lg-0
        ...
        .tarjeta-avatar
          ...
          .tarjeta.color-primario
            .text-white.p-5
              ...
              p Esta vulnerabilidad trata que otras webs pueden acceder a los datos de usuario o datos de sesión basados en cookies. Se resuelve de varias maneras, tal vez la más sencilla es agregando una configuración en el servidor.
    .row.justify-content-center.mb-5
      .col-lg-8.p-4.bg-c6
